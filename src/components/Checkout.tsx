      ...
      <div className="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
        ...
        <div className="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
          ...
          <div className="flex items-center justify-between w-full">
            <p className="text-base font-black leading-none text-gray-800">Big Data with Python</p>
          ...
          <p className="text-xs leading-3 text-gray-600 pt-2">Mentor: John</p>
          <p className="text-xs leading-3 text-gray-600 py-4">Description: </p>
          <p className="w-96 text-xs leading-3 text-gray-600">Skils: HTML CSS JAVA</p>
